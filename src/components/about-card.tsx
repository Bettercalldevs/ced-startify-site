    ...
    <>
      <Dialog open={detailsOpen} onOpenChange={setDetailsOpen}>
        <DialogTrigger asChild>
          <div id="event-card" className="relative h-full flex flex-col text-left bg-purple-700 p-6 rounded-3xl border border-purple-900 overflow-hidden cursor-pointer">
            <Grid size={20} />
            <TypographyH4 className="text-[22px] underline underline-offset-2 decoration-purple-300 text-white">
              {title}
            </TypographyH4>
